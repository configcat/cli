...
public static class CommandBuilder
{
    ...
    private static readonly CommandDescriptor[] ManageFlagCommands =
    [
        new("ls", "List all Feature Flags & Settings that belongs to the configured user",
        ...
        new("rm", "Remove a Feature Flag or Setting identified by the `--flag-id` option",
        ...
        new("update", "Update a Feature Flag or Setting identified by the `--flag-id` option",
        ...
        new("attach", "Attach Tag(s) to a Feature Flag or Setting",
        ...
        new("detach", "Detach Tag(s) from a Feature Flag or Setting",
    ...
    private static CommandDescriptor BuildEvalCommand() =>
        new("eval", "Evaluate a feature flag", "configcat eval -sk <sdk-key> -fk <flag-key> -ua id:<user-id>")
        {
    ...
    private static CommandDescriptor BuildWorkspaceCommand() =>
        new("workspace", "Manage the CLI workspace. When set, the CLI's interactive mode filters Product and Config selectors by the values set in the workspace")
        {
            ...
            [
                ...
                {
                    Aliases = ["s"],
                    Handler = CreateHandler<Workspace>(nameof(Workspace.SetAsync)),
                    Options =
                    [
                ...
                {
                    Handler = CreateHandler<Workspace>(nameof(Workspace.UnSetAsync)),
                },
                new CommandDescriptor("show", "Show the values saved in the workspace", "configcat workspace show")
                {
                    Aliases = ["sh", "p", "print"],
                    Handler = CreateHandler<Workspace>(nameof(Workspace.ShowAsync)),
                }
            ]
        };
